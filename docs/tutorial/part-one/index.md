...
1. قم بتغيير النص “أهلاً بالعالم!” إلى “أهلاً Gatsby!” وأحفظ الملف. إذا كانت النوافذ الخاصة بك جنبًا إلى جنب، يمكنك أن ترى أن تغييرات الشيفرة والمحتوى تنعكس على الفور تقريبًا في المستعرض بعد حفظ الملف.
